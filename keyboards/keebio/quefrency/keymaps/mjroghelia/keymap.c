...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[BASE] = LAYOUT_65(
		...
		KC_LSFT, KC_Z,    KC_X,    KC_C,  KC_V,            KC_B,  KC_N,            KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_UP,   MO(ADMIN),
		KC_LCTL, KC_LGUI, KC_LALT, KC_NO, LT(SYM, KC_SPC), KC_NO, LT(FN, KC_SPC), KC_RGUI, KC_RCTL, KC_NO,   KC_LEFT, KC_DOWN, KC_RGHT
	),
	...
	[WIN] = LAYOUT_65(
		...
		KC_TRNS,             KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
		KC_TRNS,             KC_TRNS, KC_TRNS, KC_LCTL, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
	),
	...
	[MAC] = LAYOUT_65(
		...
		KC_TRNS,             KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
		KC_TRNS,             KC_TRNS, KC_TRNS, KC_LGUI, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
	),

	[FN] = LAYOUT_65(
		KC_GRV, KC_F1,     KC_F2,   KC_F3,   KC_F4, KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11, KC_F12, KC_NO, KC_NO, KC_NO,
		KC_NO,  KC_NO,     CK_WEB,  CK_MAIL, KC_NO, CK_TERM, KC_MPLY, KC_NO,   KC_NO,   KC_NO,   KC_MPRV, KC_NO,  KC_NO,  KC_NO, KC_NO,
		KC_NO,  CK_ALERTS, CK_CHAT, CK_EDIT, KC_NO, KC_NO,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_NO,   KC_NO,  KC_NO,  KC_NO,
		KC_NO,  KC_NO,     KC_NO,   CK_CAL,  KC_NO, KC_NO,   KC_MNXT, KC_MUTE, KC_VOLD, KC_VOLU, KC_NO,   KC_NO,  KC_NO,  KC_NO,
		KC_NO,  KC_NO,     KC_NO,   KC_NO,   KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,  KC_NO
	),

	[SYM] = LAYOUT_65(
		KC_GRV, S(KC_1),   S(KC_2), S(KC_3), S(KC_4),   S(KC_5),    S(KC_6),    S(KC_7), S(KC_8),    S(KC_9),   S(KC_0),    S(KC_MINS), S(KC_EQL), KC_NO, KC_TRNS, KC_TRNS,
		KC_NO,  S(KC_EQL), KC_EQL,  KC_MINS, S(KC_DOT), S(KC_COMM), KC_NO,      KC_NO,   S(KC_BSLS), S(KC_DOT), S(KC_MINS), KC_NO,      KC_NO,     KC_NO, KC_NO,
		KC_NO,  S(KC_GRV), KC_NO,   S(KC_9), S(KC_0),   S(KC_LBRC), S(KC_RBRC), KC_GRV,  S(KC_QUOT), KC_QUOT,   S(KC_SCLN), KC_NO,      KC_NO,     KC_NO,
		KC_NO,  S(KC_7),   S(KC_8), KC_LBRC, KC_RBRC,   KC_BSLS,    KC_NO,      KC_NO,   KC_NO,      KC_NO,     KC_NO,      KC_NO,      KC_NO,     KC_NO,
	...
	[ADMIN] = LAYOUT_65(
		...
		KC_NO,     KC_NO, CK_WIN, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,  KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
		KC_NO,     KC_NO, KC_NO,  KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,  KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
		KC_NO,     KC_NO, KC_NO,  KC_NO, KC_NO, KC_NO, KC_NO, CK_MAC, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS,
		KC_NO,     KC_NO, KC_NO,  KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,  KC_NO, KC_NO, KC_NO, KC_NO, KC_NO
	),
