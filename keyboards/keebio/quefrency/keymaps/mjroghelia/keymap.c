...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[SYM] = LAYOUT_65(
		...
		S(KC_COMM), S(KC_EQL), KC_EQL,  KC_MINS, S(KC_DOT), KC_LBRC,    KC_RBRC,    S(KC_7), S(KC_BSLS), S(KC_DOT), S(KC_MINS), KC_NO,      KC_NO,     KC_NO, KC_NO,
		S(KC_GRV),  S(KC_8),   S(KC_4), S(KC_9), S(KC_0),   S(KC_LBRC), S(KC_RBRC), KC_GRV,  S(KC_QUOT), KC_QUOT,   S(KC_SCLN), S(KC_QUOT), KC_NO,     KC_NO,
