...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN] = LAYOUT_60(
        ...
        KC_LCTL,          KC_LGUI,          KC_LALT,          KC_LCTL,          MO(FN),           KC_NO,            LT(APP, KC_SPC),  OSL(SYM),         KC_LEFT,          KC_DOWN,          KC_UP,            KC_RGHT
    ),
    ...
    [FN] = LAYOUT_60(
        ...
        KC_TRNS,          CK_SOL,           CK_SAVE,          KC_DEL,           KC_RIGHT,         KC_NO,            KC_LEFT,          KC_DOWN,          KC_UP,            KC_RGHT,          KC_ENT,           KC_GRV,           KC_MPLY,
        KC_NO,            KC_NO,            CK_CUT,           CK_COPY,          CK_PASTE,         KC_LEFT,          KC_DOWN,          KC_MUTE,          CK_BWORD,         CK_FWORD,         KC_NO,            KC_NO,            KC_TRNS,
