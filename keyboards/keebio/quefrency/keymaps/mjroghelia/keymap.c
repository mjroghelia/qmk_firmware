...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN] = LAYOUT_65(
        ...
        KC_LCTL,          KC_LGUI,          KC_LALT,          OSL(FN),          KC_LCTL,          KC_NO,            LT(APP, KC_SPC),  KC_RGUI,          KC_RCTL,          KC_NO,            KC_LEFT,          KC_DOWN,          KC_RGHT
    ),
    ...
    [FN] = LAYOUT_65(
        ...
        KC_NO,            KC_NO,            KC_NO,            KC_TRNS,          MO(SYM),          KC_NO,            KC_BSPC,          KC_NO,            KC_NO,            KC_NO,            KC_MPRV,          KC_VOLD,          KC_MNXT
    ),
