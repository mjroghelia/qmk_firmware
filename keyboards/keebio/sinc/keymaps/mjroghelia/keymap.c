...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN] = LAYOUT_80(
        ...
        KC_LCTL,          KC_LGUI,          KC_LALT,          KC_LCTL,          KC_NO,            MO(FN),           KC_NO,            LT(SYM, KC_SPC),  MO(NUM),          KC_RGUI,          KC_RCTL,          KC_LEFT,          KC_DOWN,          KC_RGHT
    ),
    ...
    [MAC] = LAYOUT_80(
        ...
        LT(NAV, KC_ESC),  KC_A,             KC_S,             KC_D,             KC_F,             KC_G,             KC_H,             KC_J,             KC_K,             KC_L,             KC_SCLN,          KC_QUOT,          KC_ENT,           KC_PGDN,
        OSM(MOD_LSFT),    KC_Z,             KC_X,             KC_C,             KC_V,             KC_B,             KC_N,             KC_M,             KC_COMM,          KC_DOT,           KC_SLSH,          OSM(MOD_RSFT),    KC_UP,            MO(ADMIN),
        KC_LCTL,          KC_LGUI,          KC_LALT,          KC_LGUI,          KC_NO,            MO(FN),           KC_NO,            LT(SYM, KC_SPC),  MO(NUM),          KC_RGUI,          KC_RCTL,          KC_LEFT,          KC_DOWN,          KC_RGHT
    ),
