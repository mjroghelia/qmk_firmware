...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN] = LAYOUT_all(
        ...
        OSM(MOD_LSFT),    KC_Z,             KC_X,             KC_C,             KC_V,             KC_B,             KC_N,             KC_M,             KC_COMM,          KC_DOT,           KC_SLSH,          KC_NO,            OSM(MOD_RSFT),    MO(ADMIN),
    ...
    [FN] = LAYOUT_all(
        ...
        KC_NO,            KC_NO,            KC_NO,            KC_NO,            KC_NO,            KC_NO,            KC_NO,            KC_MUTE,          KC_NO,            KC_NO,            KC_NO,            KC_NO,            KC_NO,            KC_TRNS,
    ...
    [NAV] = LAYOUT_all(
        ...
        KC_LSFT,          LCTL(KC_Z),       LCTL(KC_X),       LCTL(KC_C),       LCTL(KC_V),       CK_BWORD,         KC_DOWN,          KC_NO,            KC_NO,            KC_NO,            KC_NO,            KC_NO,            KC_RSFT,          KC_NO,
    ...
    [SYM] = LAYOUT_all(
        ...
        KC_LSFT,          KC_BSLS,          KC_PERC,          KC_ASTR,          KC_LBRC,          KC_RBRC,          KC_NO,            KC_NO,            KC_NO,            KC_NO,            KC_NO,            KC_NO,            KC_RSFT,          KC_NO,
