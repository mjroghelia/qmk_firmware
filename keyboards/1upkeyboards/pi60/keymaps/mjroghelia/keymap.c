...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [SYM] = LAYOUT_all(
        ...
        KC_NO,            KC_TILD,          KC_PLUS,          KC_MINS,          KC_PIPE,          KC_LCBR,          KC_RCBR,          KC_ASTR,          KC_LPRN,          KC_RPRN,          KC_DQUO,          KC_NO,            KC_NO,            KC_NO,
        CK_CLR,           KC_EXLM,          KC_LT,            KC_EQL,           KC_GT,            KC_UNDS,          KC_AMPR,          KC_NO,            KC_NO,            KC_DQUO,          KC_TRNS,          KC_DQUO,          KC_NO,            KC_ENT,
