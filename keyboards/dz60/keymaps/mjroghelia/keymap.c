...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [SYM] = LAYOUT(
        ...
        KC_NO,            KC_TILD,          KC_LT,            KC_EQL,           KC_GT,            KC_LCBR,          KC_NO,            KC_NO,            KC_LPRN,          KC_RPRN,          KC_ASTR,          KC_NO,            KC_NO,            KC_NO,
        KC_NO,            KC_AT,            KC_DLR,           KC_PLUS,          KC_MINS,          KC_RCBR,          KC_NO,            KC_AMPR,          KC_UNDS,          KC_PIPE,          KC_TRNS,          KC_DQUO,          KC_NO,
