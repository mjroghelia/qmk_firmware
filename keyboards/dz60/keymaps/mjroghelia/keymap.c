...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN] = LAYOUT(
        ...
        KC_LCTL,          KC_LGUI,          KC_LALT,          KC_LCTL,          MO(FN),           LT(APP, KC_SPC),  OSL(SYM),         KC_LEFT,          KC_DOWN,          KC_UP,            KC_RGHT
    ),
    ...
    [FN] = LAYOUT(
        ...
        KC_NO,            KC_NO,            KC_NO,            CK_CUT,           CK_COPY,          CK_PASTE,         KC_LEFT,          KC_DOWN,          KC_MUTE,          CK_BWORD,         CK_FWORD,         KC_NO,            KC_NO,            KC_TRNS,
    ...
    [APP] = LAYOUT(
        ...
        KC_NO,            KC_NO,            KC_NO,            CK_APP7,          CK_APP8,          CK_APP9,          KC_NO,            KC_NO,            KC_NO,            KC_NO,            KC_NO,            KC_NO,            KC_NO,            KC_NO,
