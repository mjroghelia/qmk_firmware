...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN] = LAYOUT_60_ansi_split_space_rshift(
        ...
        OSM(MOD_LSFT),    KC_Z,             KC_X,             KC_C,             KC_V,             KC_B,             KC_N,             KC_M,             KC_COMM,          KC_DOT,           KC_SLSH,          OSM(MOD_RSFT),    MO(FN),
        KC_LCTL,          KC_LGUI,          KC_LALT,          KC_LCTL,          OSL(FN),          LT(APP, KC_SPC),  KC_LEFT,          KC_DOWN,          KC_UP,            KC_RIGHT
    ),
    ...
    [SYM] = LAYOUT_60_ansi_split_space_rshift(
        CK_CLR,           S(KC_1),          S(KC_2),          S(KC_3),          S(KC_4),          S(KC_5),          S(KC_6),          S(KC_7),          S(KC_8),          S(KC_9),          S(KC_0),          S(KC_MINS),       S(KC_EQL),        KC_NO,
