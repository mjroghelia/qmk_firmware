...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN] = LAYOUT(
        ...
        MO(FN),           OSM(MOD_LSFT),    KC_Z,             KC_X,             KC_C,             KC_V,             KC_B,             KC_N,             KC_M,             KC_COMM,          KC_DOT,           KC_SLSH,          OSM(MOD_RSFT),    MO(FN),
        KC_LCTL,          KC_LGUI,          KC_LALT,          KC_LCTL,          LT(FN, KC_ESC),   LT(APP, KC_SPC),  KC_RGUI,          KC_LEFT,          KC_DOWN,          KC_UP,            KC_RIGHT
    ),
