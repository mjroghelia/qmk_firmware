...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN] = LAYOUT(
        ...
        KC_LCTL,          KC_LGUI,          KC_LALT,          KC_LCTL,          MO(FN),           LT(SYM, KC_SPC),  MO(NUM),          KC_LEFT,          KC_DOWN,          KC_UP,            KC_RGHT
    ),
    ...
    [MAC] = LAYOUT(
        ...
        LT(NAV, KC_ESC),  KC_A,             KC_S,             KC_D,             KC_F,             KC_G,             KC_H,             KC_J,             KC_K,             KC_L,             KC_SCLN,          KC_QUOT,          KC_ENT,
        OSM(MOD_LSFT),    KC_NO,            KC_Z,             KC_X,             KC_C,             KC_V,             KC_B,             KC_N,             KC_M,             KC_COMM,          KC_DOT,           KC_SLSH,          OSM(MOD_RSFT),    MO(ADMIN),
        KC_LCTL,          KC_LGUI,          KC_LALT,          KC_LGUI,          MO(FN),           LT(SYM, KC_SPC),  MO(NUM),          KC_LEFT,          KC_DOWN,          KC_UP,            KC_RGHT
    ),
