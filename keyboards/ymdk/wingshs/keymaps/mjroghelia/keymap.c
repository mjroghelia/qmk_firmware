...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[BASE] = LAYOUT_all(
		...
		KC_LCTL, KC_LALT, KC_SPC,  MO(FN), LT(SYM, KC_SPC), KC_RGUI, KC_LEFT, KC_DOWN, KC_RGHT
	),
	...
	*/
	[SYM] = LAYOUT_all(
		...
		S(KC_GRV), S(KC_1),    S(KC_8), S(KC_9),   S(KC_0), KC_LBRC,    KC_RBRC,    KC_GRV,  KC_QUOT,    S(KC_QUOT), S(KC_SCLN), KC_TRNS,    KC_NO,     KC_NO,
		KC_NO,     KC_BSLS,    S(KC_2), S(KC_3),   S(KC_4), S(KC_5),    S(KC_6),    KC_NO,   S(KC_COMM), S(KC_DOT),  S(KC_SLSH), KC_NO,      KC_NO,
