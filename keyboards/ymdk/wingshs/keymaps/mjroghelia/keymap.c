...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[WIN_BASE] = LAYOUT_all(
		...
		MO(WIN_NAV), KC_A,    KC_S,    KC_D,         KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,  KC_GRV,
		KC_LSFT,     KC_Z,    KC_X,    KC_C,         KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_UP,
		KC_LCTL,     KC_LALT, KC_LCTL, MO(WIN_APPS), LT(WIN_APPS, KC_SPC),  KC_RGUI, KC_LEFT, KC_DOWN, KC_RGHT
	),
	...
	[MAC_BASE] = LAYOUT_all(
		KC_GESC,     KC_1,    KC_2,    KC_3,        KC_4,   KC_5,    KC_6,    KC_7,    KC_8,    KC_9,   KC_0,    KC_MINS, KC_EQL,  KC_BSPC, KC_DEL,
		KC_TAB,      KC_Q,    KC_W,    KC_E,        KC_R,   KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,   KC_P,    KC_LBRC, KC_RBRC, KC_BSLS, TG(MEDIA_ETC),
		MO(MAC_NAV), KC_A,    KC_S,    KC_D,        KC_F,   KC_G,    KC_H,    KC_J,    KC_K,    KC_L,   KC_SCLN, KC_QUOT, KC_ENT,  KC_GRV,
		KC_LSFT,     KC_Z,    KC_X,    KC_C,        KC_V,   KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_UP,
	...
	[MEDIA_ETC] = LAYOUT_all(
		TG(MEDIA_ETC), DF(0), DF(3),   KC_NO,   KC_NO,   KC_NO, KC_NO, KC_NO,   KC_NO,   KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,   KC_NO,
