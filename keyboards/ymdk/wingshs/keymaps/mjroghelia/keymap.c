...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[BASE] = LAYOUT_all(
		...
		KC_TAB,  KC_Q,    KC_W,    KC_E,   KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS, TG(MEDIA_ETC),
		KC_NO,   KC_A,    KC_S,    KC_D,   KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,  KC_GRV,
		KC_LSFT, KC_Z,    KC_X,    KC_C,   KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_UP,
		KC_LCTL, KC_LALT, KC_LCTL, KC_SPC, KC_SPC,  KC_RGUI, KC_LEFT, KC_DOWN, KC_RGHT
	),
	...
	[WIN] = LAYOUT_all(
		...
		KC_TRNS,     KC_TRNS, KC_TRNS, KC_TRNS,      KC_TRNS,              KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
		KC_TRNS,     KC_TRNS, KC_LCTL, MO(WIN_APPS), LT(WIN_APPS, KC_SPC), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
	),
	...
	[MAC] = LAYOUT_all(
		...
		KC_TRNS,     KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,              KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
		KC_TRNS,     KC_LGUI, KC_LGUI, KC_TRNS, LT(MAC_APPS, KC_SPC), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
	),

	[TEST] = LAYOUT_all(
		KC_TRNS, KC_TRNS,      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,         KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
		KC_TRNS, KC_TRNS,      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,         KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
		KC_TRNS, LSFT_T(KC_A), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, RSFT_T(KC_SCLN), KC_TRNS, KC_TRNS, KC_TRNS,
		KC_TRNS, KC_TRNS,      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,         KC_TRNS, KC_TRNS,
		KC_TRNS, KC_TRNS,      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
	),
	...
	[MEDIA_ETC] = LAYOUT_all(
		TG(MEDIA_ETC), TO(WIN), TO(MAC),   TG(TEST), KC_NO,   KC_NO, KC_NO, KC_NO,   KC_NO,   KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
		KC_NO,         KC_NO,   KC_NO,     KC_NO,    KC_NO,   KC_NO, KC_NO, KC_NO,   KC_NO,   KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, TG(MEDIA_ETC),
		KC_NO,         KC_NO,   KC_MPLY,   KC_MRWD,  KC_MFFD, KC_NO, KC_NO, KC_VOLD, KC_VOLU, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
		KC_NO,         KC_NO,   KC_NO,     KC_NO,    KC_NO,   KC_NO, KC_NO, KC_MUTE, KC_NO,   KC_NO, KC_NO, KC_NO, RESET,
		KC_NO,         KC_NO,   KC_NO,     KC_NO,    KC_NO,   KC_NO, KC_NO, KC_NO, KC_NO
	)
};
