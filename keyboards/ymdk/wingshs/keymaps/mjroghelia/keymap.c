...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[BASE] = LAYOUT_all(
		...
		KC_TAB,  KC_Q,    KC_W,    KC_E,   KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS, TT(MEDIA_ETC),
	...
	[MEDIA_ETC] = LAYOUT_all(
		...
		KC_NO,         KC_NO,   KC_MUTE, KC_VOLD,  KC_VOLU,  KC_NO,   KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, TG(MEDIA_ETC),
