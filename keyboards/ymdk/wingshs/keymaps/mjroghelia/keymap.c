...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[BASE] = LAYOUT_all(
		...
		KC_LSFT, KC_Z,    LT(SYM, KC_X), KC_C,   KC_V,   KC_B,    KC_N,    KC_M,    KC_COMM, LT(SYM, KC_DOT), KC_SLSH, KC_RSFT,          KC_UP,
	...
	*/
	[SYM] = LAYOUT_all(
		...
		S(KC_GRV), S(KC_2),    S(KC_1), S(KC_9),   S(KC_0), KC_LBRC,    KC_RBRC,    KC_GRV,  KC_QUOT,    KC_NO,     S(KC_SCLN), KC_TRNS,    KC_NO,     KC_NO,
		KC_NO,     KC_TRNS,    KC_TRNS, S(KC_3),   S(KC_4), S(KC_5),    S(KC_6),    S(KC_8), S(KC_QUOT), KC_TRNS,   KC_BSLS,    KC_NO,      KC_NO,
